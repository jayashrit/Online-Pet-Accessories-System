...
<head>
    ...
    <title>GJ PET ACCESSORIES SYSTEM</title>
    <!-- Bootstrap -->
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" name="keyword" class="form-control" placeholder="Search....." style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:rgb(228, 55, 25);text-transform:uppercase;margin-bottom:0px;">  PET ACCESSORIES </h2>
           </div>
        </div>      
